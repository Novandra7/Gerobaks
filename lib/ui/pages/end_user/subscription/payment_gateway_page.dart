...
class _PaymentGatewayPageState extends State<PaymentGatewayPage>
    ...
    try {
      ...
      if (mounted) {
        ...
        showAppSuccessDialog(
          ...
          message: 'Langganan ${widget.plan.name} Anda telah aktif',
          ...
          onPressed: () async {
            ...
            if (!widget.isFromSignup && result == true) {
              if (mounted) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppNotif(title: 'Pembayaran', showBackButton: true),
          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(Icons.star, color: greenColor, size: 24),
              ),
