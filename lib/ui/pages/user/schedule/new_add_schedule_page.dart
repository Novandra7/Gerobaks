...
class _AddSchedulePageState extends State<AddSchedulePage> with TickerProviderStateMixin {
  ...
  // Validation Helper
  String? _validateRequired(String errorMessage) {
    return (value) {
  ...
  Future<void> _submitForm() async {
    ...
    try {
      // Create new schedule
      final newSchedule = await _scheduleService.createSchedule(
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: 'e.g., Organic, Inorganic',
                              ...
                              validator: _validateRequired('Please enter the waste type'),
                              autovalidateMode: _hasUserInteraction 
                                  ? AutovalidateMode.onUserInteraction 
                                  : AutovalidateMode.disabled,
                              onChanged: (value) {
