                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                '${_schedules.length} jadwal tersedia',
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4),
                                Text(
                                  'Buat jadwal pengambilan sampah untuk lokasi Anda',
                                  style: whiteTextStyle.copyWith(
                                    fontSize: 12,
                                    fontWeight: light,
                                  ),
                                ...
                                child: Container(
                                  ...
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      hintText: 'Cari jadwal atau alamat...',
                    ...
                    if (isCoordinates)
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Icon(Icons.map, color: greenColor, size: 16),
                        ),
                      ),
                  ],
                ),
