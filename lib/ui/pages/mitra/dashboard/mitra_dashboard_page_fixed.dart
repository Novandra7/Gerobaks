...
class _MitraDashboardContentState extends State<MitraDashboardContent> {
  ...
  // Widget komponen yang dapat digunakan kembali
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    // Jenis sampah
                    _buildTag(label: 'Organik', color: greenColor),
                    SizedBox(width: ResponsiveHelper.getResponsiveSpacing(context, 8)),
                    // Berat
                    _buildTag(label: '2 kg', color: Colors.grey),
                  ],
                ),
              ],
            ),
  ...
  // Widget untuk menampilkan header section dengan title dan indikator
