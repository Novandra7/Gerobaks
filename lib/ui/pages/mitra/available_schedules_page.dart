...
class AvailableSchedulesPage extends StatefulWidget {
  const AvailableSchedulesPage({super.key});

  @override
  State<AvailableSchedulesPage> createState() => _AvailableSchedulesPageState();
}
  ...
  Widget _buildBody() {
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemCount: _schedules.length + 2, // +2 for info and loading indicator
        itemBuilder: (context, index) {
          ...
          // Load more button (fallback if auto-scroll doesn't trigger)
          if (_hasMorePages) {
            return Padding(
